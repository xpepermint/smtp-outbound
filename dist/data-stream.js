...
exports.DataStream = undefined;

var _stream = require('stream');

class DataStream extends _stream.Transform {
  ...
  _transform(chunk, encoding, done) {
    ...
    if (typeof chunk === 'string') {
      chunk = new Buffer(chunk, 'uft8');
    }

    this._bytesSize += chunk.length;
    this._lastByte = chunk[chunk.length - 1];
    this.push(chunk);
